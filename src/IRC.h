...
#define IRC_MAX_CHANNELS 4      // 3 if using a tilemap width of 128, otherwise 6. If changed; search and replace "%-22s" in IRCState.c/IRC.c, this changes the number of characters to fit in title string (-21 = 6 channels, -22 = 5 etc)
