...
Do note that the MD is a 5v system! That means you should take care to not connect any random serial device directly to the MD (Such as a PC).
Use a device such as a max3232 between your MD and remote device to translate the voltage levels.
